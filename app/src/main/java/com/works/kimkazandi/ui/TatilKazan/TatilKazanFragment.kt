...
class TatilKazanFragment : Fragment() {
    ...
    lateinit var tatilKazanViewModel: TatilKazanViewModel
    ...
    override fun onCreateView(
        ...
        tatilKazanViewModel =
            ViewModelProvider(
                ...
                TatilKazanViewModel::class.java
            )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Thread {
            tatilKazanViewModel.TatilKazanfetchData()
        }.start()
        ...
        tatilKazanViewModel.list.observe(viewLifecycleOwner) {
        ...
        listView.setOnItemClickListener { adapterView, view, i, l ->
            ...
            controller.navigate(R.id.action_nav_tatilkazan_to_raffleDetailFragment, bundle)
